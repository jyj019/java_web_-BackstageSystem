  ...
  <body>
   		<form action="${pageContext.request.contextPath }/servlet/UserServlet?method=update" method="post">
   			...
   			<table border="1" width="600" align="center">
   				...
   				<tr>
   					<td>密码：</td>
   					<td><input type="password" name="password" value="${user1.password }" /></td>
   				...
   				<tr>
   					<td>身份证：</td>
   					<td><input type="text" name="identity" value="${user1.identity }"/></td>
   				
   				</tr>
   				<tr>
   				<tr>
   					<td>学校：</td>
   					<td><input type="text" name="school" value="${user1.school }" / ></td>
